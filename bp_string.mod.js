...
registerMod(() => {
  ...
  const mod = class ModImpl extends shapez.Mod {
    ...
    init() {
      ...
      this.modInterface.runAfterMethod(shapez.HUDBlueprintPlacer, 'createBlueprintFromBuildings', async function() {
  ...
  function serializeBlueprintString(entities) {
    let minPos = entities.reduce((r, b) => [
